"""Python script that generates Fig. 10b of arXiv:2509.07931v1, i.e.,
the local spectral function and the converged hybridization functions
are compared with CT-HYB solution for the 2x2-4b-4sb system at
half-filling.
"""
...
def main() -> None:
    ...
    analyzer.plot_hybridization_spectrum(
        ...
        save="./output/spectra_hybz_2x2_4b_4sb_half_filling.pdf",
    )
    return
