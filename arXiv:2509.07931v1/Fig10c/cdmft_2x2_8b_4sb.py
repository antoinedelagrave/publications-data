"""Python script that generates Fig. 10c of arXiv:2509.07931v1, i.e.,
the local spectral function and the converged hybridization functions
are compared with CT-HYB solution for the 2x2-8b-4sb system at
half-filling.
"""

import pyqcm
import pyqcm.cdmft
from cluster_model import CM
...
def main() -> None:
    ...
    analyzer.plot_hybridization_spectrum(
        ...
        save="./output/spectra_hybz_2x2_8b_4sb_half_filling.pdf",
    )
    return
