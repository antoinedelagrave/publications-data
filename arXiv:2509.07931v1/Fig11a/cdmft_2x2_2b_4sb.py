"""Python script that generates Fig. 11a of arXiv:2509.07931v1, i.e.,
...
# Setting parameters
model.set_target_sectors(["R0:N4:S0/R0:N5:S-1/R0:N5:S1/R0:N6:S0"])
...
def main() -> None:
    ...
    analyzer.plot_hybridization_spectrum(
        ...
        spectrum_file="./doped_spectrum.json",
        save="./output/spectra_hybz_2x2_2b_4sb_doped.pdf",
    )
