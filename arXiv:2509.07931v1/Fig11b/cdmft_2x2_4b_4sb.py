"""Python script that generates Fig. 11b of arXiv:2509.07931v1, i.e.,
the local spectral function and the converged hybridization functions
are compared with CT-HYB solution for the 2x2-4b-4sb system away from
half-filling.
"""
...
model = pyqcm.lattice_model("2D-4s-4b-4sb", [clus], [[2, 0, 0], [0, 2, 0]])
...
# Setting parameters
model.set_target_sectors(["R0:N6:S0/R0:N7:S-1/R0:N7:S1/R0:N8:S0"])
...
def main() -> None:
    ...
    analyzer.plot_hybridization_spectrum(
        ...
        save="./output/spectra_hybz_2x2_4b_4sb_doped.pdf",
    )
    return
