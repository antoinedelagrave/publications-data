...
visualizer.set_link_style(
    0, 0, color="#8BB68A", label=r"$\boldsymbol{\theta}^{1}$", style="dashed"
)
visualizer.set_link_style(
    0, 1, color="#B19CD9", label=r"$\boldsymbol{\theta}^{2}$", style="dashed"
)
visualizer.set_link_style(
    1, 0, color="#8BB68A", label=r"$\boldsymbol{\tilde{\theta}}^{1}$", style="dashed"
)
visualizer.set_link_style(
    1, 1, color="#B19CD9", label=r"$\boldsymbol{\tilde{\theta}}^{2}$", style="dashed"
)
