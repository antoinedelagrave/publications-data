...
the KS comparison between the 1x2-8b-1sb and 1x2-4b-2sb systems. Important
...
def main(run_cdmft: bool = False, sub_baths_weights: list = [], session_id: str = '') -> None:
    ...
    if run_cdmft:
        ...
        analyzer.compare_spectral_functions(
            w_range=(-6, 10),
            spectrum_files='./spectrum_1x2-8b-1sb-2orbs.json',
            only_independent=True,
            save='./output/1x2-8b-1sb-2orbs_vs_1x2-4b-2sb-2orbs.pdf',
            legend_options={
                ...
                'custom_labels': [r'$N_{\mathrm{b}}=8$, $N_{\mathrm{sb}}=2$', r'$N_{\mathrm{b}}=8$, $N_{\mathrm{sb}}=1$'],
                'include_models': None,
            },
            cluster=visualizer,
